		...
		<div id="AboutMe" className={aboutMeStyles.container}>
			...
			<div className={aboutMeStyles.largeBook}>
				<div className={aboutMeStyles.page1}>
					<div className={aboutMeStyles.erikaDP}></div>
				...
				<div className={`${aboutMeStyles.page2} 
								 ${firstTwoPages ? aboutMeStyles.showPage2 : aboutMeStyles.hidePage2}`}>
				...
				<div className={`${aboutMeStyles.page3} 
								 ${firstTwoPages ? aboutMeStyles.hidePage3 : aboutMeStyles.showPage3}`}>
			...
			<button onClick={() => setFirstTwoPages(true)}>Prev</button>
			<button onClick={() => setFirstTwoPages(false)}>Next</button>
			<p>{firstTwoPages ? "Next Page : 1-2" : "Next Page : 3-4"}</p>
		</div>
	)
}
